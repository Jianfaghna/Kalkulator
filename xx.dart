...
class _LoginPageState extends State<LoginPage> {
  ...
  final String correctPassword = "kocakgemink";
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: GridView.count(
          crossAxisCount: 2,
          children: <Widget>[
            _buildMenuCard(context, 'Pembagian', Icons.group, DivisionPage()),
...
class _DivisionPageState extends State<DivisionPage> {
  ...
  void _calculateDivision() {
    ...
    double num2 = double.tryParse(_number2Controller.text) ?? 1;
    setState(() {
      if (num2 != 0) {
        result = "Hasil Pembagian: ${(num1 / num2).toStringAsFixed(2)}";
      } else {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Pembagian")),
      body: Padding(
        padding: const EdgeInsets.all(16.0),
        child: Column(
